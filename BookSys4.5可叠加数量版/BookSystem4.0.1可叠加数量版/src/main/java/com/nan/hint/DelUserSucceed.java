 ...
 * 删除用户成功后显示的消息窗口
 */
public class DelUserSucceed {


    //删除成功后弹出的删除成功的消息窗
    public void win(){
        //MainApp.staticdata.countuserdelwin = 1;//本窗体是否已经存在以及只能存在一个该窗体的判断代码
        ...
        win.addMouseListener(new MouseListener() {//定义删除成功窗口中按钮的监听事件
            ...
            public void mouseClicked(MouseEvent e) {//鼠标单击事件
                ...
                //MainApp.staticdata.countuserdelwin = 0;//将验证是否存在此窗口的判断重置为0，方便下次再次弹出成功信息窗口
        ...
        jwin.addWindowListener(new WindowAdapter() {//添加窗体监听器
            ...
            public void windowClosing(WindowEvent e) {//窗口关闭时执行的代码
                ...
                //MainApp.staticdata.countuserdelwin = 0;  //countup重置为0
            }
