...
public class Updata {
    ...
    //该窗口为修改图书信息的窗口
    void updata() {
        Only.UpdataCount = 1;//设置图书修改界面以及存在，不可再创建，此处状态码为1，表示存在该窗口
        ...
        textField3.setText(StaticData.bokName);//设置文本框默认文字信息，此处为书的名称
        ...
        textField4.setText(StaticData.bokAuthor);//设置文本框默认文字信息，此处为书的作者
        ...
        textField5.setText(StaticData.bokPrice.toString());//设置文本框默认文字信息，此处为书的价格
        ...
        textField6.setText((String.valueOf(StaticData.bokAmount)));//设置文本框默认文字信息，此处为书的作者
        ...
        textField7.setText(StaticData.bokType);//设置文本框默认文字信息，此处为书的类型
        ...
        bupdata2.addMouseListener(new MouseListener() {//为修改按钮添加鼠标监听事件
            ...
            public void mouseClicked(MouseEvent e) {//鼠标单击事件
                ...
                new UpdataDao().updata2(BOKname,BOKauthor,BOKprice,BOKamount,BOKtype);//传入参数以进行修改数据库信息
        ...
        jframe.addWindowListener(new WindowAdapter() {//添加窗体监听器
            ...
            public void windowClosing(WindowEvent e) {//窗口关闭时执行的代码
                ...
                Only.UpdataCount = 0;//设置修改图书界面不存在，以后可以再次创建
            }
